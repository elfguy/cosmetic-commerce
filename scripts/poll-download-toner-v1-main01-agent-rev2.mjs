...
const key='01-representative-main-agent-rev2-preserve-product';
const targetUrl='https://chatgpt.com/c/6a224475-fa80-83a3-8a1f-09a6c48fd80e';
...
if(!chosen){await page.screenshot({path:path.join(root,'tmp-toner-main01-agent-rev2-poll-failed.png'),fullPage:true}); throw new Error('no generated candidate');}
