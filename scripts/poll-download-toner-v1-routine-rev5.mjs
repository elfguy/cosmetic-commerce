...
let page=ctx.pages().reverse().find(p=>p.url().includes('6a224249-5410-83a9-a802-77646848c54f'));
if(!page){ page=await ctx.newPage(); await page.goto('https://chatgpt.com/c/6a224249-5410-83a9-a802-77646848c54f',{waitUntil:'domcontentloaded',timeout:60000}); }
...
if(!chosen){ await page.screenshot({path:path.join(root,'tmp-toner-routine-rev5-poll-failed.png'),fullPage:true}); throw new Error('no generated candidate'); }
