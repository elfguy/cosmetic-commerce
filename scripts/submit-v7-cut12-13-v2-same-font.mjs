...
const commonRefs = [
  ...
  path.join(outDir, 'reference/cut12-v2v3-01-structure-product-info-ingredients.png'),
  path.join(outDir, 'reference/cut12-v2v3-02-product-info-ingredients-source.png'),
];

const jobs = [
  {
    key: '12-eco-direct-sale-info-v2-same-font',
    prompt: 'prompts/12-eco-direct-sale-info-v2-same-font-submitted.txt',
    uploadFiles: commonRefs,
  },
  {
    key: '13-full-ingredients-v2-same-font',
    prompt: 'prompts/13-full-ingredients-v2-same-font-submitted.txt',
    uploadFiles: commonRefs,
  },
];
