...
const refs=[
 ...
 path.join(base,'raw/01-representative-main-agent-generated-raw.png')
];
...
await page.screenshot({path:path.join(root,'tmp-toner-main01-agent-rev2-before-send.png'),fullPage:true});
