...
rows = [
    ...
    ('화장품제조업자 및\n화장품책임판매업자', '(주)유어스킨'),
    ('제조국', '대한민국'),
    ('[화장품법]에 따라\n기재·표시하여야 하는\n모든 성분', '정제수, 카프릴릭/카프릭트라이글리세라이드, 글리세린, 시어버터, 나이아신아마이드, 폴리글리세릴-3다이스테아레이트, 세테아릴올리베이트, 프로판다이올, 세테아릴알코올, 솔비탄올리베이트, 비타민나무열매추출물, 다이프로필렌글라이콜, 해바라기씨오일, 마카다미아씨오일, 아르간커넬오일, 하이드록시아세토페논, 카보머, 카프릴릴글라이콜, 글리세릴스테아레이트시트레이트, 판테놀, 알지닌, 부틸렌글라이콜, 밀싹추출물, 브로콜리추출물, 양배추추출물, 자주개자리추출물, 무씨추출물, 유채추출물, 펜틸렌글라이콜, 글루타티온, 다이포타슘글리시리제이트, 다이소듐이디티에이, 토코페롤, 1,2-헥산다이올'),
