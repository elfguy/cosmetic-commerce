...
export const marketingWorkspaces: MarketingWorkspace[] = [
  {
    ...
    versions: [
      {
        id: 'v4-gpt-web-candidate',
        label: 'V4 GPT Web Candidate',
        status: 'candidate',
        date: '2026-06-01',
        summary: 'ChatGPT 웹/GPT Images로 생성 후 다운로드한 V4 상세 10장 후보입니다. Hermes 로컬 이미지 생성이나 코드 렌더링이 아니라 웹 GPT 이미지 결과물만 등록했습니다.',
        preview: '/coupang/images/aqua-lotion/versions/v4-gpt-web/v4-gpt-web-contact-sheet.png',
        primaryUrl: '/coupang/images/aqua-lotion/versions/v4-gpt-web/v4-gpt-web-contact-sheet.png',
        links: [
          { label: 'V4 GPT Web 컨택시트', href: '/coupang/images/aqua-lotion/versions/v4-gpt-web/v4-gpt-web-contact-sheet.png', kind: 'image' },
          ...
          { label: '상세 05', href: '/coupang/images/aqua-lotion/versions/v4-gpt-web/detail/05.png', kind: 'image' },
          { label: '상세 10', href: '/coupang/images/aqua-lotion/versions/v4-gpt-web/detail/10.png', kind: 'image' },
          { label: '01 프롬프트', href: '/coupang/images/aqua-lotion/versions/v4-gpt-web/prompt-01.txt', kind: 'source' },
          { label: '02~10 프롬프트', href: '/coupang/images/aqua-lotion/versions/v4-gpt-web/prompt-02-10.txt', kind: 'source' },
        ],
        metrics: [
          { label: '생성 방식', value: 'ChatGPT Web' },
          { label: '상세', value: '10' },
          { label: '크기', value: '887×1774 / 881×1785' },
        ],
      },
      {
        ...
        status: 'candidate',
        date: '2026-06-01',
        summary: 'V4에서 문제였던 특허·EWG·제조일자·포장/직접판매 컷을 안전 문구와 코드 렌더링으로 수정한 상세 10장 후보입니다.',
        preview: '/coupang/images/aqua-lotion/versions/v41/v41-detail-contact-sheet.png',
        primaryUrl: '/coupang/images/aqua-lotion/versions/v41/v41-detail-contact-sheet.png',
        links: [
          { label: 'V4.1 상세 컨택시트', href: '/coupang/images/aqua-lotion/versions/v41/v41-detail-contact-sheet.png', kind: 'image' },
          { label: '비교 페이지', href: '/marketing/aqua-lotion-version-compare/', kind: 'page' },
          { label: '상세 01', href: '/coupang/images/aqua-lotion/versions/v41/detail/01.png', kind: 'image' },
          { label: '상세 05 수정본', href: '/coupang/images/aqua-lotion/versions/v41/detail/05.png', kind: 'image' },
          { label: '상세 10 수정본', href: '/coupang/images/aqua-lotion/versions/v41/detail/10.png', kind: 'image' },
        ],
        metrics: [
          { label: '상세', value: '10' },
          { label: '수정 컷', value: '4' },
      ...
      },
      {
        ...
        label: 'Original / V1 / V2 / V3 Compare',
        status: 'review',
        date: '2026-05-31',
        summary: '현재 적용본인 원본과 V1, V2, V3 후보의 대표 이미지와 상세 이미지 흐름을 한 화면에서 비교하는 기준 페이지입니다.',
        preview: '/coupang/images/aqua-lotion/versions/v3/representative/01.png',
        primaryUrl: '/marketing/aqua-lotion-version-compare/',
        links: [
          { label: '비교 페이지', href: '/marketing/aqua-lotion-version-compare/', kind: 'page' },
          { label: 'V3 대표 컨택시트', href: '/coupang/images/aqua-lotion/versions/v3/v3-representative-contact-sheet.jpg', kind: 'image' },
          { label: 'V3 상세 컨택시트', href: '/coupang/images/aqua-lotion/versions/v3/v3-detail-contact-sheet.jpg', kind: 'image' },
        ],
        metrics: [
          { label: '버전', value: '4' },
          { label: '대표', value: '22' },
