...
export const campaignModels: CampaignModel[] = [
  {
    ...
    styling: '펄화이트 비대칭 디테일 니트 · 아이스블루 플리츠 미디스커트 · 실버 메시 발레 플랫',
    strengths: ['20대 성인으로 보이는 맑고 환한 얼굴', '아이스블루 유리광의 수분 화장품 캠페인 적합', '손·발·전신 비율 안정'],
    risks: ['스튜디오 피부 보정을 실제 UGC 수준으로 낮춰야 함', '영상에서는 유리광 배경보다 실제 욕실 채광으로 자연스럽게 전환해야 함'],
  ...
  },
  {
    ...
    styling: '미드나이트 네이비 원숄더 니트 · 딥체리 바이어스컷 미디스커트 · 버건디 키튼힐 슬링백',
    strengths: ['밝고 환한 프리미엄 뷰티 얼굴', '로지 프리즘 조명과 성숙하고 세련된 분위기', '목선·헤어·유동적인 치마 실루엣의 광고 주목도'],
    risks: ['조명과 포즈가 과해지면 생활 UGC보다 에디토리얼처럼 보일 수 있음', '원숄더 라인은 영상 생성에서 의상 형태를 고정해야 함'],
