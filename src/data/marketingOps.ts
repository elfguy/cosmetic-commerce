...
export const productOpsStatuses: ProductOpsStatus[] = [
  ...
  },
  {
    ...
    detailStatus: 'V1 상세 12컷 후보 생성 완료 — 11번 제품정보/전성분 표 원본 보존',
    assetStatus: 'V1 후보 제작 완료 — 쿠팡 미반영',
    claimRisk: 'low',
  ...
  'moisture-lip-balm': [
    {
      ...
      status: 'candidate',
      date: '2026-06-15',
      summary: '모이스춰 립밤 V1 상세 후보입니다. 상세 12컷으로 정리했으며 11번 제품정보/전성분 표는 법정 문구 정확도 우선으로 원본을 보존했습니다.',
      mainImages: Array.from({ length: 5 }, (_, i) => '/coupang-main/moisture-lip-balm/' + String(i + 1).padStart(2, '0') + '.png'),
