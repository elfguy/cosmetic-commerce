...
export const productVersions: Record<string, ProductVersion[]> = {
  'aqua-lotion': [
    ...
    },
    {
      ...
      detailImages: Array.from({ length: 9 }, (_, i) => '/coupang/images/aqua-lotion/versions/v3/detail/' + String(i + 1).padStart(2, '0') + '.png'),
      links: [
        { label: '버전 비교', href: '/marketing/aqua-lotion-version-compare/' },
        { label: '대표 컨택시트', href: '/coupang/images/aqua-lotion/versions/v3/v3-representative-contact-sheet.jpg' },
        { label: '상세 컨택시트', href: '/coupang/images/aqua-lotion/versions/v3/v3-detail-contact-sheet.jpg' },
      ],
      metrics: [
        { label: '대표', value: '5' },
        { label: '상세', value: '9' },
