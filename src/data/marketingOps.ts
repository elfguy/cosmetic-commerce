...
export const productOpsStatuses: ProductOpsStatus[] = [
  ...
  },
  {
    ...
    detailStatus: 'V4 상세 15컷 정리 완료',
    assetStatus: 'V4 검수/업로드 준비',
    claimRisk: 'medium',
    nextAction: 'V4 15컷을 쿠팡 업로드용으로 확인',
  ...
  'aqua-lotion': [
    {
      ...
      status: 'candidate',
      date: '2026-06-03',
      summary: 'GPT Images 작업 결과를 V4로 정리한 아쿠아로션 대표 6장과 상세 15컷입니다. V2 대표이미지 톤을 기반으로 V4 대표이미지를 추가했습니다.',
